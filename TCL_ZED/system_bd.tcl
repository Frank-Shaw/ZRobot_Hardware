...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.GPIO2_BOARD_INTERFACE {leds_8bits} CONFIG.GPIO_BOARD_INTERFACE {sws_8bits} CONFIG.USE_BOARD_FLOW {true}  ] $axi_gpio_0
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins optical/S_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M02_AXI [get_bd_intf_pins Motor_Ctrl_L/Motor_S_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M03_AXI [get_bd_intf_pins Motor_Ctrl_R/Motor_S_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M04_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M04_AXI] [get_bd_intf_pins ultrasonic_0/S00_AXI]
  ...
  connect_bd_net -net in_phA_1 [get_bd_ports motorR_phA] [get_bd_pins Motor_Ctrl_R/in_phA]
  connect_bd_net -net in_phA_1_1 [get_bd_ports motorL_phA] [get_bd_pins Motor_Ctrl_L/in_phA]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs optical/S_AXI/Reg] SEG_optical_Reg
